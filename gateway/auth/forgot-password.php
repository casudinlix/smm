...
$tipe = "Lupa Kata Sandi";
        ...
        if (isset($_POST['lupa'])) {
            ...
            $mail->IsSMTP();
            $mail->SMTPSecure = 'ssl'; 
            $mail->Host = "grosirpanel-smm.online"; //host masing2 provider email
            $mail->SMTPDebug = 2;
            $mail->Port = 465;
            $mail->SMTPAuth = true;
            $mail->Username = "cs@grosirpanel-smm.online"; //user email
            $mail->Password = "vespatua1"; //password email 
            $mail->SetFrom("cs@grosirpanel-smm.online","grosirpanel"); //set email pengirim
