...
function dapetin($url) {
        ...
        if (isset($_POST['daftar'])) {
            ...
            $secret_key = '6LcfZMMZAAAAAB11ZbErwFigf7GKRudUsxc06KhX'; //masukkan secret key-nya berdasarkan secret key masing-masing saat create api key nya
                        ...
                        <div class="form-section">
                            ...
                            <div class="login-inner-form">
                                <form class="form-horizontal" role="form" method="POST">
									...
									<div class="form-group form-box">
                                       <div class="g-recaptcha" data-sitekey="6LcfZMMZAAAAAEQCaW3R0RWXAkZgJZN9xsgqspzc"></div>
									</div>
