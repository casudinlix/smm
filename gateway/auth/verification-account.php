...
$tipe = "Verifikasi Akun";
	    ...
	    if (isset($_POST['kirim_kode'])) {
	        ...
	        $mail->IsSMTP();
	        $mail->SMTPSecure = 'ssl'; 
	        $mail->Host = "dingpanel.site"; //host masing2 provider email
	        $mail->SMTPDebug = 2;
	        $mail->Port = 465;
	        $mail->SMTPAuth = true;
	        $mail->Username = "cs@dingpanel.site"; //user email
	        $mail->Password = "vespatua123456"; //password email 
	        $mail->SetFrom("cs@dingpanel.site","Ding Panel"); //set email pengirim
