...
require '../lib/session_login_admin.php';
        ...
        if (isset($_POST['tambah_top_up'])) {
            ...
            if ($cek_data->num_rows == 0) {
                ...
                if ($conn->query("UPDATE provider_pulsa SET code = '$code', link = '$link', api_key = '$GetKey', api_id = '$GetApiID' WHERE id = '$id'") == true) {
...
?>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" style="width: 200px;" name="api_key" value="<?php echo $ShowData['api_key']; ?>"></td>
...
?>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" style="width: 200px;" name="key" value="<?php echo $Data['api_key']; ?>"></td>
                                    <td><input type="text" class="form-control" style="width: 200px;" name="key" value="<?php echo $Data['api_id']; ?>"></td>
                                    <td align="center">
