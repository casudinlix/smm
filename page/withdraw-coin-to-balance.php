...
require '../lib/session_user.php';
        ...
        if (isset($_POST['tarik'])) {
	        ...
	        $post_metode = $conn->real_escape_string($_POST['radio6']);
							...
							<div class="form-group row">
								...
								<div class="col-lg-9 col-xl-6">
									<select class="form-control" name="tipe" id="tipe">
										...
										<option value="0">Tipe Penarikan Tidak Ditemukan!</option>
										<?php } else {
										while($data_metod = $cek_metod->fetch_array()){ ?>
							...
							<div class="form-group row">
								...
								<div class="col-lg-9 col-xl-6">
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" name="jumlah" placeholder="Masukkan Jumlah Tarik Koin Kamu" id="jumlah">
                                    </div>
