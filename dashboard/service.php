...
<body>
        ...
        <header class="header-global">
            <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
                <div class="container">
                    <a class="navbar-brand" href="index.php"><img src="<?php echo $config['web']['url'] ?>assets/media/logos/logo.png" alt="logo" height="55" width="55"></a>
                    <button
        ...
        <section class="features">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
		                <div class="box">
                            <h4 class="m-t-0 header-title text-center"><b>Daftar Harga Layanan Top Up & App Digital</b></h4>
                                <form class="form-horizontal" role="form" method="POST">
							        <div class="form-group">
								        <label>Tipe</label>
								        <select class="form-control" id="tipe" name="tipe">
									        ...
									        <option value="STREAMING">Akun Premium</option>
        ...
        <footer class="footer">
            <div class="container text-center">
                ...
                <p>Copyright © 2020 <?php echo $data['short_title']; ?>.</p>
            </div>
        </footer>
        <!-- End Footer -->
