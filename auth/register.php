...
function dapetin($url) {
        ...
        if (isset($_POST['daftar'])) {
            ...
            $secret_key = '6LdUK70aAAAAANjpxIBPxS7AF7jJUsAIHHosqMsN'; //masukkan secret key-nya berdasarkan secret key masing-masing saat create api key nya
	        ...
	        if (mysqli_num_rows($kode_ref) == 0) {
                ...
                $api_key =  acak(20);
                    ...
                    if ($conn->query("INSERT INTO users VALUES ('', '$nama_depan', '$nama_belakang', '$nama_depan $nama_belakang', '$email', '$username', '$hash_password', '0', '0', '0', 'Member', 'Aktif', 'Verifikasi', '$pin', '$api_key', 'Pendaftaran Gratis', '$pengguna', '$date', '$time', '0', '$no_hp', '', '$kode_ref', '', '0')") == true) {
...
?>
        ...
        <!-- Start Page Register -->
        <div class="login-2" style="background-image: url('<?php echo $config['web']['url'] ?>assets/media/bg/bg-1.png');">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-section">
                            ...
                            <div class="login-inner-form">
                                <form class="form-horizontal" role="form" method="POST">
                                    ...
                                    <div class="form-group form-box">
                                        <input type="text" class="input-text" placeholder="kosongkan saja" name="kode_referral" value="<?php echo $kode_referral; ?>">
                                        <i class="fa fa-gift"></i>
                                        <small class="text-danger font-13 pull-right"><?php echo ($error['kode_referral']) ? $error['kode_referral'] : '';?></small>
                                    </div>
									<div class="form-group form-box">
                                       <div class="g-recaptcha" data-sitekey="6LdUK70aAAAAAEEM-Cb7I-P4Dco5iC333DXs1BCT"></div>
									</div>
                                    <div class="checkbox clearfix">
                                        <div class="form-check checkbox-theme">
                                            <input class="form-check-input" type="checkbox" value="" id="rememberMe">
                                            <label class="form-check-label" for="rememberMe">
                                                Saya Setuju Dengan<a href="<?php echo $config['web']['url'] ?>page/tos">Ketentuan Layanan</a>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <br />
                                    <p>Belum Verifikasi Akun ?<a href="<?php echo $config['web']['url'] ?>auth/verification-account"> Verifikasi Disini</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
