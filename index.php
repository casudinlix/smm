...
?>
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
	        <div class="kt-container">
	            <div class="kt-subheader__main">
		            <h3 class="kt-subheader__title">Halaman Utama</h3>
        ...
        <script>swal("Hallo <?php echo $sess_username; ?>", "Selamat Berbelanja", "success"</script>
	                ...
	                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="<?php echo $config['web']['url'] ?>assets/media/slide/8.jpg" alt="Slide Pertama">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<?php echo $config['web']['url'] ?>assets/media/slide/23.png" alt="Slide Kedua">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<?php echo $config['web']['url'] ?>assets/media/slide/08.jpg" alt="Slide Ketiga">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="<?php echo $config['web']['url'] ?>assets/media/slide/96.jpg" alt="Slide Keempat">
                            </div>
                        </div>
		        ...
		        <div class="col-lg-12">
		            <div class="kt-portlet kt-portlet--height-fluid">
                        <div class="kt-portlet__body">
	                        <div class="row">
		                        <div class="col-6">
			                        <h4 class="mb-0 text-primary" style="margin-top: -5px !important; margin-bottom: -10px !important;"><img src="<?php echo $config['web']['url'] ?>assets/media/icon/uangg.png" width="20px"><font color="black"> Isi Saldo</font></h4>
		                        </div>
		                        <div class="col-6 text-right" style="margin-top: -10px !important; margin-bottom: -10px !important;">
			                        <a href="<?php echo $config['web']['url'] ?>deposit-balance" class="btn btn-primary btn-sm"> <i class="fas fa-plus-circle"></i> Isi Saldo</a> 
		                        </div>
	                        </div>
                        </div>
		            </div>
                            ...
                            <span class="border border-primary">
                                <div class="card-body">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            <a href="<?php echo $config['web']['url'] ?>order/social-media"><img src="<?php echo $config['web']['url'] ?>assets/media/icon-pay/igg.png" alt=""><span>Sosmed</span></a>
                                        </div>
                                    </div>
                                </div>
                            </span>
                        ...
                        <div class="card mb-3 catagory-card">
                            <span class="border border-primary">
                                <div class="card-body">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            <a href="<?php echo $config['web']['url'] ?>order/pulsa-reguler"><img src="<?php echo $config['web']['url'] ?>assets/media/icon-pay/pulsaa.png" alt=""><span>Pulsa</span></a>
                                        </div>
                                    </div>
                                </div>
                            </span>
                        ...
                        <div class="card mb-3 catagory-card">
                            <span class="border border-primary">
                                <div class="card-body">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            <a href="<?php echo $config['web']['url'] ?>order/saldo-emoney"><img src="<?php echo $config['web']['url'] ?>assets/media/icon-pay/emoneyy.png" alt=""><span>E-Money</span></a>
                                        </div>
                                    </div>
                                </div>
                            </span>
                        ...
                        <div class="card mb-3 catagory-card">
                            <span class="border border-primary">
                                <div class="card-body">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            <a href="<?php echo $config['web']['url'] ?>order/paket-data-internet"><img src="<?php echo $config['web']['url'] ?>assets/media/icon-pay/dataaa.png" alt=""><span>Paket Data</span></a>
                                        </div>
                                    </div>
                                </div>
                            </span>
                        ...
                        <div class="card mb-3 catagory-card">
                            <span class="border border-primary">
                                <div class="card-body">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            <a href="<?php echo $config['web']['url'] ?>order/paket-sms-telepon"><img src="<?php echo $config['web']['url'] ?>assets/media/icon-pay/smms.png" alt=""><span>Telpon & SMS</span></a>
                                        </div>
                                    </div>
                                </div>
                            </span>
                        ...
                        <div class="card mb-3 catagory-card">
                            <span class="border border-primary">
                                <div class="card-body">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            <a href="<?php echo $config['web']['url'] ?>order/voucher-game"><img src="<?php echo $config['web']['url'] ?>assets/media/icon-pay/sticckk.png" alt=""><span>Voucher Game</span></a>
                                        </div>
                                    </div>
                                </div>
                            </span>
                        ...
                        <div class="card mb-3 catagory-card">
                            <span class="border border-primary">
                                <div class="card-body">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            <a href="<?php echo $config['web']['url'] ?>order/pln-pascabayar"><img src="<?php echo $config['web']['url'] ?>assets/media/icon-pay/ppob.png" alt=""><span>Pascabayar</span></a>
                                        </div>
                                    </div>
                                </div>
                            </span>
                        ...
                        <div class="card mb-3 catagory-card">
                            <span class="border border-primary">
                                <div class="card-body">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            <a href="<?php echo $config['web']['url'] ?>order/token-pln"><img src="<?php echo $config['web']['url'] ?>assets/media/icon-pay/plnn.png" alt=""><span>Token Listrik</span></a>
                                        </div>
                                    </div>
                                </div>
                            </span>
                        ...
                        <div class="card mb-3 catagory-card">
                            <span class="border border-primary">
                                <div class="card-body">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            <a href="<?php echo $config['web']['url'] ?>order/pulsa-internasional"><img src="<?php echo $config['web']['url'] ?>assets/media/icon-pay/hp.png" alt=""><span>Pulsa Inter</span></a>
                                        </div>
                                    </div>
                                </div>
                            </span>
                        ...
                        <div class="card mb-3 catagory-card">
                            <span class="border border-primary">
                                <div class="card-body">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            <a href="<?php echo $config['web']['url'] ?>order/wifi-id"><img src="<?php echo $config['web']['url'] ?>assets/media/icon-pay/wifi.png" alt=""><span>Wifi ID</span></a>
                                        </div>
                                    </div>
                                </div>
                            </span>
                        ...
                        <div class="card mb-3 catagory-card">
                            <span class="border border-primary">
                                <div class="card-body">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            <a href="<?php echo $config['web']['url'] ?>order/voucher"><img src="<?php echo $config['web']['url'] ?>assets/media/icon-pay/ijooo.png" alt=""><span>Voucher</span></a>
                                        </div>
                                    </div>
                                </div>
                            </span>
                        ...
                        <div class="card mb-3 catagory-card">
                            <span class="border border-primary">
                                <div class="card-body">
                                    <div class="card shadow">
                                        <div class="card-body">
                                            <a href="<?php echo $config['web']['url'] ?>order/streaming"><img src="<?php echo $config['web']['url'] ?>assets/media/icon-pay/merah.png" alt=""><span>Streming</span></a>
                                        </div>
                                    </div>
                                </div>
                            </span>
        ...
        <div class="kt-container">
            <div class="cta-area">
                <div class="cta-text px-4 py-5" style="background-image: url(<?php echo $config['web']['url'] ?>assets/media/bg/3.jpg)">
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__body kt-portlet__body--fit">
                        <div class="kt-widget28" class="h-75 d-inline-block">
                            <div class="kt-widget28__visual" style="background-image: url(<?php echo $config['web']['url'] ?>assets/media/bg/bg-4.jpg)" class="rounded"></div>
			                <div class="kt-widget28__wrapper kt-portlet__space-x">
			                    <ul class="nav nav-pills nav-fill kt-portlet__space-x" role="tablist">
			                        <li class="nav-item">
			                            <a class="nav-link active" href="<?php echo $config['web']['url'] ?>deposit-balance"><span><img src="<?php echo $config['web']['url'] ?>assets/media/icon/top-up.svg" width="50px"></span></span>Isi Saldo</span></a>
			                        </li>
			                        <li class="nav-item">
			                            <a class="nav-link active" href="<?php echo $config['web']['url'] ?>history/order"><span><img src="<?php echo $config['web']['url'] ?>assets/media/icon/shopping-cart.svg" width="50px"></span><span>Riwayat Pesanan</span></a>
			                        </li>
			                        <li class="nav-item">
