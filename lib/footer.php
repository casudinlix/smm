		...
		<div class="kt-footer  kt-footer--extended  kt-grid__item" id="kt_footer">
			...
			<div class="kt-container ">
				<div class="row">
					...
					<div class="col-lg-3">
						<div  class="kt-footer__section">
							<h3 class="kt-footer__title">Berlangganan</h3>
							<div class="kt-footer__content">
								<form action="" class="kt-footer__subscribe">
									<div class="input-group">
										...
										<div class="input-group-append">
											...
											<button type="button" class="btn btn-primary btn-elevate btn-pill btn-elevate-air"><i class="flaticon2-send-1 text-warning"></i> Gabung</button>
										</div>
									</div>
								</form>
							</div>
