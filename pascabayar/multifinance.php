            ...
            $header = array(
			    ...
			    if ($provider == "DG-PULSA" && $json_result['data']['status'] == "Gagal") {
			        ...
			        if ($provider == "DG-PULSA") {
		                ...
		                $item_name = $json_result['data']['desc']['item_name'];
		                $no_rangka = $json_result['data']['desc']['no_rangka'];
		                $no_pol = $json_result['data']['desc']['no_pol'];
		                $tenor = $json_result['data']['desc']['tenor'];
		                $tagihan = $admin;
			        }
