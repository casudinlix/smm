        ...
        if (isset($_POST['buat'])) {
		    ...
		    if ($data_metod['tipe'] == 'Transfer Bank') {
			    $post_jumlah = $post_jumlah + rand(000,999);
	                ...
	                $insert = $conn->query("INSERT INTO deposit VALUES ('', '$kode', '$sess_username', '".$data_metod['tipe']."', '".$data_metod['provider']."', '$post_pengirim', '".$data_metod['tujuan']." ".$data_metod['nama_penerima']."', '".$data_metod['catatan']." $saldo','$post_jumlah', '$get_saldo', '$tipe_saldo', 'Pending', '$date', '$time')");
	                if ($insert == TRUE) {
        ...
        <div class="row">
						        ...
						        <div class="col-lg-9 col-xl-6">
							         <div class="kt-radio-list">
								        <label class="kt-radio kt-radio--bold kt-radio--brand">
									        <input type="radio" name="radio7" id="metod" value="saldo_sosmed">Sosmed Pay
									        <span></span>
								        </label>
								        <label class="kt-radio kt-radio--bold kt-radio--brand">
									        <input type="radio" name="radio7" id="metod" value="saldo_top_up">Grosir PAY
									        <span></span>
								        </label>
	        ...
	        <div class="col-lg-5">
		        <div class="kt-portlet">
			        ...
			        <div class="kt-portlet__body">
						<p><b>Sosmed Pay</b> (Jika ingin melakukan pembelian follower,subscribe,like DLL.)</p>
						<p><b>Grosir PAY</b> (Jika ingin melakukan pembelian PULSA,PLN,pemabayaran PPOB DLL)</p>
