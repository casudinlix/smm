...
require '../lib/session_user.php';
        ...
        if (isset($_POST['pesan'])) {
			...
			if ($provider == "MANUAL") {
			    ...
			    if ($provider == "NAYPEDIA" AND $json_result['status'] == false) {
				    $_SESSION['hasil'] = array('alert' => 'danger', 'pesan' => 'Ups, '.$json_result['data']['pesan']);
			    } else {
			        
                     if ($provider == "NAYPEDIA") {
			            ...
			            if ($provider_oid == "") {
    			            ...
    			            $_SESSION['hasil'] = array('alert' => 'success', 'pesan' => 'Pesanan Berhasil Dibuat.<br />Target : '.$post_target.'<br />Jumlah : '.$jumlah.'<br />');
				        } else {
