...
?>
                                            <tr>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <button data-toggle="tooltip" title="Copy Target" class="btn btn-primary btn-sm" type="button" onclick="copy_to_clipboard('target-<?php echo $data_pesanan['oid']; ?>')"><i class="las la-copy"></i></button>
                                                </div>
                                                <td>Rp <?php echo number_format($data_pesanan['harga'],0,',','.'); ?></td>
                                                
                                                <td><span class="btn btn-<?php echo $label2; ?> btn-elevate btn-circle btn-icon"><i class="flaticon2-<?php echo $icon2; ?>"></i></span></td>
                                                </td>
                                            </tr>   
<?php } ?>
                                        </tbody>
