...
if ($data_metode['provider'] == 'Telkomsel') { ?>
							...
							<div class="form-group row">
								...
								<div class="col-lg-9 col-xl-6">
									<input type="text" class="form-control" placeholder="Contoh : 6282136611003" value="<?php echo $post_pengirim; ?>" name="pengirim">
       ...
       <!--                             <div class="input-group">-->
       <!--                                 <div class="input-group-prepend"><span class="input-group-text text-primary">Rp</span></div>-->
       <!--                                 <input type="number" class="form-control" name="saldo" value="0" id="rate" readonly>-->
       <!--                             </div>-->
							<!--	</div>-->
							<!--</div>-->
...
<?php } else if ($data_metode['provider'] == 'GOPAY') { ?>
							...
							<div class="form-group row">
								<label class="col-xl-3 col-lg-3 col-form-label">Masukan USERNAME</label>
								<div class="col-lg-9 col-xl-6">
									<input type="text" class="form-control" placeholder="" value="<?php echo $post_pengirim; ?>" name="pengirim">
									<span class="form-text text-muted"><?php echo ($error['pengirim']) ? $error['pengirim'] : '';?></span>
								</div>
							</div>
							<div class="form-group row">
...
<?php } else if ($data_metode['provider'] == '3') { ?>
...
<?php } else if ($data_metode['provider'] == 'MANDIRI (VIRTUAL AKUN)') { ?>
